...
class UserMovementMeterWeeklyGraphState extends State<_UserMovementMeterWeeklyGraph> {  
  ...
  var _getUserMovementMeterWeeklyGraphAPI, _clearUserMovementMeterWeeklyGraphActionCreator;
  ...
  Widget build(BuildContext context) {
    ...
    return new StoreConnector<AppState, Map>(
      onInitialBuild: (Map stateObject) {
        ...
        _clearUserMovementMeterWeeklyGraphActionCreator = stateObject["clearUserMovementMeterWeeklyGraph"];
        Map _params = new Map();
      ...
      converter: (Store<AppState> store) {
        ...
        returnObject["clearUserMovementMeterWeeklyGraph"] = () =>
            store.dispatch(ClearUserMovementMeterWeeklyGraph());  
          ...
          return new Scaffold(
            ...
            appBar: new AppBar(
              ...
              leading: IconButton(                  
                ...
                onPressed: () {
                  this._clearUserMovementMeterWeeklyGraphActionCreator();
